...
import { CLASH_DOWNLOADS, detectOS, platformMatches, usePlatform } from "./platform";

// 平台识别与下载清单已拆到 ./platform：首页/TokenStatus/AuthMagic 只需要那些辅助，
// 本文件（教程本体）随 /guide 路由懒加载，不进首屏 bundle
